            ...
            <div className="w-full h-full pt-52">
              <div className="w-full">
                ...
                <ul className="relative list-disc text-2xl mt-12 font-inter w-full">
                  <li className="relative left-[16vw] p-3">Create a dashboard</li>
                  <li className="relative left-[48vw] p-3">Establishes rules of coexistence</li>
                  <li className="relative left-[27vw] p-3">Know the relevant data</li>
                  <li className="relative left-[8vw] p-3">Add your users</li>
                  <li className="relative -left-[2vw] p-3">Show everyone's debts</li>
                </ul>
              </div>
            </div>
          </Container>
