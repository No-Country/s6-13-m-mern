    ...
    <section className='mt-20 mb-28 px-5 lg:px-44 max-w-[1700px]'>
      ...
      <main className='sm:px-[10%]'>
        <div className="w-full flex sm:flex-row flex-col-reverse items-center gap-2 mb-20 justify-between">
          <div className="w-fit">
            <div className=" justify-between animate-fadeInLeft">
              <h3 className="mb-5 text-[24px]"><span className="text-blueDark font-bold min-w-fit">How</span> to start with Consortia?</h3>
              <p className="mb-3 text-[18px]"><span className="text-blueDark font-semibold">Create</span> your account</p>
              <p className="mb-3 text-[18px]"><span className="text-blueDark font-semibold">Validate</span> your account</p>
              <p className="mb-3 text-[18px]">Wait to be <span className="text-blueDark font-semibold">accepted</span> in your consortium</p>
            </div>
          </div>
          <div>
            <img className="min-w-[200px] animate-fadeInRight" src="./assets/features/image1.png" alt="" />
          </div>
        </div>

        <div className="w-full flex sm:flex-row flex-col items-center gap-2 mb-20 justify-between">
          <div>
            <img className="min-w-[200px] animate-fadeInLeft" src="./assets/features/image2.png" alt="" />
          </div>
          <div className="w-fit">
            <div className="justify-between animate-fadeInLeft">
        ...
        <div className="w-full flex sm:flex-row flex-col-reverse items-center gap-2 mb-20 justify-between">
          ...
          <div>
            <img className="min-w-[200px] animate-fadeInRight" src="./assets/features/image3.png" alt="" />
          </div>
        </div>

        <div className="w-full flex sm:flex-row flex-col items-center gap-2 mb-20 justify-between">
          <div>
            <img className="min-w-[200px] animate-fadeInLeft" src="./assets/features/image4.png" alt="" />
          </div>
          <div className="w-fit">
            <div className="justify-between animate-fadeInLeft">
              ...
              <p className="mb-3 text-[18px] text-center text-[#004AAD] font-semibold underline cursor-pointer"><a>Download App</a></p>
            </div>
          </div>
        </div>
